...
//   cy.get('[data-testid="test-emailAddress"]').type("dola@yopmail.com");

//   cy.get('[data-testid="test-password"]').type("P@ssword01{enter}");

//   cy.get('[href="/appointments"]').click();

//   cy.get("div.cursor-pointer > .flex").click();
...
//   cy.get('[data-testid="test-01:00 PM"]').click();
...
//   cy.get('[data-testid="test-check"]').click();

//   cy.contains("Pay 4000").click();

//   cy.get(".justify-end > .bg-success").click();

//   cy.contains("Next").click();

//   cy.contains("e-Shift").click();
});
